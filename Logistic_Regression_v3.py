...
fileName = "C:\\Users\\ASUS\\Desktop\\DataSets\\Continuous_Bivariate_Analysis.pdf"
...
fileName = "C:\\Users\\ASUS\\Desktop\\DataSets\\Categorical_Bivariate_Analysis.pdf"
pdf = PdfPages(fileName)
...
# Example: Precision = 0.9 & Recall = 0.8, then F1 score = 0.847 
#(F1 score is high when both Precision & Recall are high)
# Example: Precision = 0.9 & Recall = 0.2, then F1 score = 0.327 
#(F1 score is low when either or both Precision/Recall is/are low)
